...
namespace duckdb {
    ...
    Transaction::Transaction(ClientContext &context_p,
                             transaction_t start_time,
                             transaction_t transaction_id,
                             timestamp_t start_timestamp,
                             idx_t catalog_version) : context(context_p.shared_from_this()),
                                                      ...
                                                      temporary_objects(context_p.client_data->temporary_objects),
                                                      undo_buffer(context.lock()),
