...
//! parser representation into the DuckDB representation
    ...
    public:
        ...
        bool TransformParseTree(duckdb_libpgquery::PGList *tree, vector<unique_ptr<SQLStatement>> &sqlStatementVector);
    ...
    private:
        ...
        unique_ptr<TableRef> TransformRangeVar(duckdb_libpgquery::PGRangeVar *pgRangeVar);
