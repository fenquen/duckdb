...
//! database on disk
    ...
    public:
        StorageManager(DatabaseInstance &databaseInstance, string path, bool read_only);
...
//! Stores database in a single file.
    ...
    public:
        SingleFileStorageManager(DatabaseInstance &databaseInstance, string path, bool read_only);
