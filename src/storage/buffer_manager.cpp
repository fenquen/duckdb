...
namespace duckdb {
    ...
    BufferManager::BufferManager(DatabaseInstance &databaseInstance,
                                 string tempDirectory,
                                 idx_t maximum_memory) : db(databaseInstance),
                                                         current_memory(0),
                                                         maximum_memory(maximum_memory),
                                                         temp_directory(move(tempDirectory)),
                                                         queue(make_unique<EvictionQueue>()),
                                                         temporary_id(MAXIMUM_BLOCK),
                                                         queue_insertions(0),
                                                         buffer_allocator(BufferAllocatorAllocate,
                                                                          BufferAllocatorFree,
